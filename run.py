...
add_equation_in_latex("f: \R \\rightarrow \R \ 2\pi \\text{-periodisch, mit }"
"\\newline f(x) = 0  \\text {, falls } -\pi<x<0 \\text{ und } \mathrm{e}^{-x}  \\text {, falls } 0 \leq x \leq \pi")
...
add_equation_in_latex("f: \R \\rightarrow \R \ \\text{ gerade und }  2\pi \\text{-periodisch, mit }"
"\\newline f(x) = \pi - x  \\text {, für }  0 \leq x \leq \pi")
...
"\\newline f(x) = \\frac{2}{L} \ x  \\text {, falls } 0 \leq x< \\frac{L}{2} \\text{ und } \\frac{2}{L} \left( L-x \\right)  \\text {, falls } \\frac{L}{2} \leq x \leq L")
...
add_equation_in_latex("g: \R \\rightarrow \R \ \\text{ ungerade und }  P \\text{-periodisch, mit }"
"\\newline g(x) = \\frac{2}{L} \ x  \\text {, falls } 0 \leq x< \\frac{L}{2} \\text{ und } \\frac{2}{L} \left( L-x \\right)  \\text {, falls } \\frac{L}{2} \leq x \leq L")
